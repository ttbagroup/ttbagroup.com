...
break;case 'url':regExp=/^((https?|ftp):\/\/)?[a-zA-ZÑ‘Ð°-ÑÐÐ-Ð¯ÐÑ‘Ã¤Ã¶Ã¼Ã„Ã–ÃœÃŸÃ¨Ã©Ã»0-9][a-zA-ZÑ‘Ð°-ÑÐÐ-Ð¯ÐÑ‘Ã¤Ã¶Ã¼Ã„Ã–ÃœÃŸÃ¨Ã©Ã»0-9\.\-]{0,253}\.[a-zA-ZÑ‘Ð°-ÑÐÐ-Ð¯]{2,10}\/?$/;if(val.length>0){str=val.split('//');if(str&&str.length>1){str=str[1]}else{str=str[0]}
...
break;case 'name':regExp=/^([ÐÑ‘Ã¤Ã¶Ã¼Ã„Ã–ÃœÃŸÃ¨Ã©Ã»ÒÒ‘Ð„Ñ”Ð†Ñ–Ð‡Ñ—A-Za-z\u0370-\u03FF\u0400-\u04FF\u0590-\u05FF\u0600-\u06FF\u3040-\u30FF]{1,})([ÐÑ‘Ã¤Ã¶Ã¼Ã„Ã–ÃœÃŸÃ¨Ã©Ã»ÒÒ‘Ð„Ñ”Ð†Ñ–Ð‡Ñ—A-Za-z\u0370-\u03FF\u0400-\u04FF\u0590-\u05FF\u0600-\u06FF\u3040-\u30FF\-\'\s\.]{0,})$/gi;if(val.length>0&&!val.match(regExp)){error.type.push('name')}
...
break;case 'string':regExp=/^[A-Za-zÐ-Ð¯Ð°-ÑÐÑ‘ÐÑ‘Ã¤Ã¶Ã¼Ã„Ã–ÃœÃŸÃ¨Ã©Ã»0-9,\.:;\"\'\`\-\_\+\?\!\%\$\@\*\&\^\s]$/i;if(val.length>0&&!val.match(regExp)){error.type.push('string')}
break;default:break}}
